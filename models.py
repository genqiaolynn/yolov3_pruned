...
class YOLOLayer(nn.Module):
    ...
    def __init__(self, anchors, num_classes, img_dim=416):
        ...
        self.focal_loss = FocalLoss(nn.BCELoss(), gamma=0.5)
        self.obj_scale = 1
    ...
    def forward(self, x, targets=None, img_dim=None):
        ...
        if targets is None:
            ...
            loss_conf_obj = self.focal_loss(pred_conf[obj_mask], tconf[obj_mask])
            loss_conf_noobj = self.focal_loss(pred_conf[noobj_mask], tconf[noobj_mask])
...
class Darknet(nn.Module):
    ...
    def load_darknet_weights_raw(self, weights_path):
